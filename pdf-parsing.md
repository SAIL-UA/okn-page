...
#### [camelot-pdf-extract-all-tables.py](https://github.com/akfike/pdf-table-parser/blob/main/camelot-pdf-extract-all-tables.py)
...
1. **Upload the PDF to be Parsed**
   ...
   - [Example PDF](https://github.com/akfike/pdf-table-parser/blob/main/pdfs/2021%20TEDS-A%20Codebook.pdf)
...
4. **Check the Output**
   ...
   - [Example Output](https://github.com/akfike/pdf-table-parser/blob/main/csvs/nhes_pfi_table_0.csv)

### Parsing CSVs into Formatted/Structured CSVs

#### [parse_camelot_table_nhss.py](https://github.com/akfike/pdf-table-parser/blob/main/parse_camelot_table_nhss.py)
...
1. **Examine Parsed CSV Files**
    ...
    - [Example CSV](https://github.com/akfike/pdf-table-parser/blob/main/csvs/nhes_pfi_table_0.csv)
...
#### [merge_parsed_csvs.py](https://github.com/akfike/pdf-table-parser/blob/main/merge_parsed_csvs.py)
...
3. **Verify the Output**
    ...
    - [Example Output](https://github.com/akfike/pdf-table-parser/blob/main/csvs/clean_csvs/nmhss_2020_codebook.csv)

### Extracting Variable Names from File (CSV or TSV)

#### [extract_variable_names_csv.py](https://github.com/akfike/pdf-table-parser/blob/main/extract_variable_names_csv.py)
...
#### [verify_all_variables_extracted.py](https://github.com/akfike/pdf-table-parser/blob/main/verify_all_variables_extracted.py)
